...
class S3GoogleMavenCacheService(
    private val cacheProperties: IndexingConfigurationProperties,
    private val s3StorageService: S3StorageService
) : GoogleMavenCacheService {
    private val bucketName = cacheProperties.gmaven.s3.bucketName
    ...
    private fun getS3Key(groupId: String): String {
        ...
        return "${cacheProperties.gmaven.s3.prefix}/$fileName"
    }
}
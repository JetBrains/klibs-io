 ...
 * @property releaseTs time of release of this package
...
class PackageIndexingKnownException(
    ...
    val scmUrl: String?,
) : RuntimeException("Unable to find tooling metadata for ${coordinates.groupId}:${coordinates.artifactId}:${coordinates.version}")

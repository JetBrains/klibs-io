...
INSERT INTO public.scm_repo (id_native, id, owner_id, has_gh_pages, has_issues, has_wiki, has_readme, created_ts, updated_at, last_activity_ts, stars, open_issues, name, description, homepage, license_key, license_name, default_branch, minimized_readme)
VALUES (8001, 8001, 9001, false, true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 10, 1, 'repo-8001', 'Repo 8001', NULL, 'mit', 'MIT License', 'main', 'readme');

-- Insert scm_repo for no packages
INSERT INTO public.scm_repo (id_native, id, owner_id, has_gh_pages, has_issues, has_wiki, has_readme, created_ts, updated_at, last_activity_ts, stars, open_issues, name, description, homepage, license_key, license_name, default_branch, minimized_readme)
VALUES (9100, 9100, 9001, false, true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 10, 1, 'repo-9100', 'Repo 9100', NULL, 'mit', 'MIT License', 'main', 'readme');

-- Insert test project
INSERT INTO public.project VALUES (9001, 9001, CURRENT_TIMESTAMP, '2.0.0', CURRENT_TIMESTAMP);

-- Insert different project
INSERT INTO public.project VALUES (8001, 8001, CURRENT_TIMESTAMP, '2.0.0', CURRENT_TIMESTAMP);
...
INSERT INTO public.package VALUES (8002, 8001, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'org.second', 'libC', '2.0.0', 'org.second:libC', 'Lib C', 'https://second.com/libC', 'gradle', '8.0', '2.0.0', '[]'::jsonb, NULL, '[]'::jsonb, '[]'::jsonb, 'SEARCH_MAVEN');

-- Targets for older libA (should NOT be counted for libA)
INSERT INTO public.package_target (package_id, platform, target) VALUES (9002, 'NATIVE', 'linux_x64');
...
INSERT INTO public.package_target (package_id, platform, target) VALUES (9003, 'JS', NULL);
...
INSERT INTO public.package_target (package_id, platform, target) VALUES (8002, 'JS', NULL);

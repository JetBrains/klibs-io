...
@Deprecated("Legacy for /search/packages GET endpoint")
data class SearchPackageResultDTOTargetList(
    @Schema(
    ...
    @Schema(
        description = "Targets supported by the package. Predefined values.",
        example = "[\"common:ios\", \"jvm:android\"]"
    )
